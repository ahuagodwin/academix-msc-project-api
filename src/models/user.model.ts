...
import { IUser, UserType } from '../types/types';
...
const userSchema = new Schema<IUser>(
  {
    ...
    faculty: { type: mongoose.Schema.Types.ObjectId, required: function () {
      return this.user_type === UserType.CLIENT || this.user_type === UserType.TEACHER;
    },  trim: true },
    department: { type: mongoose.Schema.Types.ObjectId, required: function () {
      return this.user_type === UserType.CLIENT || this.user_type === UserType.TEACHER;
    }, trim: true },
    school: { type: mongoose.Schema.Types.ObjectId, ref: "School", required: function () {
      return this.user_type === UserType.CLIENT || this.user_type === UserType.TEACHER;
    } },
