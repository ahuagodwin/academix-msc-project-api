...
roleRouter.put("/role/assign/update/", authorized_md_1.authProtect, (0, authorized_md_1.authorize)("update_role"), roleService.updateAssignedRolesToUser);
...
roleRouter.get("/user/assign/:userId/", authorized_md_1.authProtect, (0, authorized_md_1.authorize)("read_role"), roleService.getAllUsersWithRoleByUserId);
